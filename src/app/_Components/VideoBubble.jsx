    ...
    <div className="bg-white p-4 rounded-md shadow-md max-w-3xl mx-auto">
      ...
      <div className="py-4">
        ...
        <div className="mt-4 flex items-center">
          ...
          <div className="hover:bg-gradient-to-r from-pink-500 to-yellow-500 hover:text-white border-red-600 border-1 border px-8 py-2 rounded-md flex items-center w-full">
