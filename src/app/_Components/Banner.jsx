...
function Banner() {
  ...
  <div class="relative flex flex-wrap bg-[#599d6a] px-4 py-3 sm:flex-nowrap sm:items-center sm:justify-center sm:gap-3 sm:pr-8 md:px-8">
    ...
    <a href="#" class="order-last inline-block w-full whitespace-nowrap rounded-lg bg-gray-100 px-2 py-1 text-center text-xs font-semibold text-black outline-none ring-indigo-300 transition duration-100  focus-visible:ring active:bg-red-800 hover:outline-red-400 sm:order-none sm:w-auto outline-1 md:text-sm">Complete onboarding</a>    
  </div>
  {/* <!-- banner - end --> */}
</div>
   </>
